...
<div class="jumbotron">
        <div class="editable">
            <?php
            $text = 'Anonymous';
            if (!isset($_SESSION['medium_names'])) {
                $_SESSION['medium_names'] = [];
            }
            if (isset($_POST['text']) and !empty($_POST['text']) && !in_array($_POST['text'], $_SESSION['medium_names'])) {
                $_SESSION['medium_names'][] = $_POST['text'];
            }
            echo xss_medium_escape(implode('<br>', $_SESSION['medium_names']));
            ?>
        </div>
</div>
