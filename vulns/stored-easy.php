...
<div class="jumbotron">
        <div class="editable">
            <?php
            $text = 'Anonymous';
            if (!isset($_SESSION['easy_names'])) {
                $_SESSION['easy_names'] = [];
            }
            if (isset($_POST['text']) and !empty($_POST['text']) && !in_array($_POST['text'], $_SESSION['easy_names'])) {
                $_SESSION['easy_names'][] = $_POST['text'];
            }
            echo xss_easy_escape(implode('<br>', $_SESSION['easy_names']));
            ?>
        </div>
</div>
